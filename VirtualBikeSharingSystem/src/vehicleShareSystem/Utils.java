...
public class Utils 
{
     ...
     */
    public static void enviarMensaje(Agent agent, String tipo, Object objeto, String comment)
    {
        ...
        try
        {
            if(dfd!=null)
            {
            	...
            	for(int i=0;i<dfd.length;i++)
            		if(!agent.getAID().getName().equals(dfd[i].getName().getName()))
